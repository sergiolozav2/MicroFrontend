...
const donaChart = [
  { name: "Licencia vencida", value: 15, fill: "#2F41BA" },
  { name: "Luces dañadas", value: 34, fill: "#6388F8" },
  { name: "Extintor vencido", value: 21, fill: "#8fb0fc" },
];

const empresaChart = [
  { name: "Enero", value: 1.0, prediction: null },
  { name: "Febrero", value: 2.9, prediction: null },
  { name: "Marzo", value: 1.2, prediction: null },
  { name: "Abril", value: 1.6, prediction: null },
  { name: "Mayo", value: 0.9, prediction: 0.9 },
  { name: "Junio", value: null, prediction: 1.0 },
  { name: "Julio", value: null, prediction: 1.8 },
];
      ...
      <div className="mt-3 flex flex-col px-6">
        ...
        <div className="mt-8 flex w-full flex-col gap-x-3 gap-y-7 xl:flex-row">
          ...
          <div className="flex w-full flex-col xl:w-8/12">
            <p>Índice de incumplimiento de plantas</p>
